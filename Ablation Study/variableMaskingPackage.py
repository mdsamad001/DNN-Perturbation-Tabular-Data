...
def maskExtLow(W, percentage=0.05): 
    
    lim_upper =(W.max())*percentage
    lim_lower = (W.min())*percentage
    B1 = W > lim_upper
    B2 = W < lim_lower
...
def weight_perc(Wold,W,mtype,percentage):
    ...
    if mtype == 'Low':
            ...
            Wn = maskExtLow(W, percentage=percentage)
